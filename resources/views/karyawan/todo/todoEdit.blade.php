    ...
    <div class="card-body">
        <form method="POST" id="form-edit">
            ...
            <div class="form-group">
                ...
                <input type="text" name="judul" id="judul" class="form-control" placeholder="Masukan Judul" value="{{ $data->judul }}">
            </div>
            <div class="form-group">
